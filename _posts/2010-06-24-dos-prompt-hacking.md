...
* Ping
[<img src="http://1.bp.blogspot.com/_GDf-7K4UaMw/TB2z5QUkNAI/AAAAAAAAAC0/ITDpThzNPGE/s320/Untitled.jpg" style="width: 800px;"/>]({{ site.baseurl }}/)
Sample Preview is the command `ping-t localhost` "localhost" is the ip of computer we own.

Utiliy is used to find the existence of the remote  host. Who to send a SYN signal to the remote host and remote host if it  meant there was reply to a remote machine. If you want to know the  commands used in the ping type `ping [host]` then the ping command will  exit. And one of them we can use to attack a simple Dos.
